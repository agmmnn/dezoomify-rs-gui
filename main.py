...
class MainFrame ( wx.Frame ):
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"dezoomify-rs GUI \U0001F980 v0.1 ", pos = wx.DefaultPosition, size = wx.Size( 810,510 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.m_staticText21 = wx.StaticText( self, wx.ID_ANY, u"dezoomify-rs GUI \U0001F980", wx.DefaultPosition, wx.Size( -1,38 ), 0 )
		self.m_staticText21.Wrap( -1 )

		self.m_staticText21.SetFont( wx.Font( 17, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_LIGHT, False, "Segoe UI Semibold" ) )
		...
		self.m_url = wx.TextCtrl( self, wx.ID_ANY, u"", wx.Point( -1,-1 ), wx.Size( -1,35 ), 0|wx.BORDER_SIMPLE )
		self.m_url.SetFont( wx.Font( 10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
		...
		self.m_buttonX = wx.Button( self, wx.ID_ANY, u"\U00002716", wx.DefaultPosition, wx.Size( -1,36 ), wx.BORDER_NONE|wx.BU_EXACTFIT )
		self.m_buttonX.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
		...
		self.m_buttonV = wx.Button( self, wx.ID_ANY, u"\U00002714", wx.DefaultPosition, wx.Size( -1,36 ), wx.BORDER_NONE|wx.BU_EXACTFIT )
		self.m_buttonV.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
		...
		self.m_buttonV1 = wx.Button( self, wx.ID_ANY, u"Add \U00002795", wx.DefaultPosition, wx.Size( 100,36 ), wx.BORDER_NONE|wx.BU_EXACTFIT )
		self.m_buttonV1.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
		...
		bSizer3.Add( fgSizer5, 0, wx.ALIGN_CENTER|wx.EXPAND, 5 )

		bSizer31 = wx.BoxSizer( wx.HORIZONTAL )

		m_listBox1Choices = []
		self.m_listBox1 = wx.ListBox( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, m_listBox1Choices, 0|wx.BORDER_NONE|wx.HSCROLL )
		self.m_listBox1.SetFont( wx.Font( 10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
		...
		self.m_buttonX1 = wx.Button( self, wx.ID_ANY, u"Delete", wx.DefaultPosition, wx.Size( -1,-1 ), wx.BORDER_NONE|wx.BU_EXACTFIT )
		self.m_buttonX1.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
		...
		self.m_buttonX11 = wx.Button( self, wx.ID_ANY, u"Clear All", wx.DefaultPosition, wx.Size( -1,-1 ), wx.BORDER_NONE|wx.BU_EXACTFIT )
		self.m_buttonX11.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
		...
		self.m_buttonV2 = wx.Button( self, wx.ID_ANY, u"Open in Browser", wx.DefaultPosition, wx.Size( -1,-1 ), wx.BORDER_NONE|wx.BU_EXACTFIT )
		self.m_buttonV2.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
		...
		self.m_buttonSave = wx.Button( self, wx.ID_ANY, u"Save", wx.DefaultPosition, wx.Size( -1,-1 ), wx.BORDER_NONE|wx.BU_EXACTFIT )
		self.m_buttonSave.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
		...
		self.m_buttonLoad = wx.Button( self, wx.ID_ANY, u"Load", wx.DefaultPosition, wx.Size( -1,-1 ), wx.BORDER_NONE|wx.BU_EXACTFIT )
		self.m_buttonLoad.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
		...
		self.m_status = wx.StaticText( self, wx.ID_ANY, u"Status:", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_status.Wrap( -1 )
		self.m_status.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
		...
		self.m_checkBox1 = wx.CheckBox( self, wx.ID_ANY, u"Add Copied URLs", wx.DefaultPosition, wx.Size( -1,-1 ), 0 )
		self.m_checkBox1.SetValue(True)
		self.m_checkBox1.SetFont( wx.Font( 10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
		...
		bSizer4.Add( self.m_checkBox1, 0, wx.ALIGN_RIGHT|wx.ALL, 5 )

		bSizer3.Add( bSizer4, 0, wx.EXPAND, 5 )

		bSizer7 = wx.BoxSizer( wx.HORIZONTAL )

		self.m_download = wx.Button( self, wx.ID_ANY, u"Start Download", wx.DefaultPosition, wx.Size( -1,42 ), wx.BORDER_NONE|wx.BU_EXACTFIT|wx.BORDER_SIMPLE )
		self.m_download.SetFont( wx.Font( 11, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
	...
	def ClipboardListener(self):
		...
		while 1:
			...
			if cb!=cb_last and cb_last.startswith("http") and self.m_checkBox1.IsChecked():
				cb=cb_last
				self.adder(cb_last)
	...
	def m_buttonClearAllOnButtonClick( self, event ):
		...
		if count!=0:
			dlg = wx.MessageDialog(self, 'Are you sure you want to delete all '+str(count)+' items in the list?', 'Clear All List!', wx.YES_NO | wx.ICON_INFORMATION)
	...
	def downloader(self):
		...
		dezpath=os.path.dirname(sys.argv[0])+"\\dezoomify-rs.exe"
		listcount=self.m_listBox1.GetCount()
		if listcount!=0:
			infolist=[]
			...
			for i in range(0,listcount):
				...
				#run process
				p=subprocess.run([dezpath, "-l", url], capture_output=True, startupinfo=stinfo)
				if "\\nDone!\\n" in str(p.stdout):
			...
			self.m_status.SetLabel("Download info: "+str(len(succ))+" successful, "+str(listcount-len(succ))+" errors.")
...
class EditDialog(wx.Dialog):
    ...
    def InitUI(self):
        self.SetBackgroundColour(wx.Colour( 45, 56, 72 ))
        self.input.SetFont( wx.Font( 11, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
...
class LibFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Downloaded Images \U0001F3DB", pos = wx.DefaultPosition, size = wx.Size( 1067,640 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.m_Label = wx.StaticText( self, wx.ID_ANY, u"Downloaded Images \U0001F3DB", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_Label.Wrap( -1 )

		self.m_Label.SetFont( wx.Font( 12, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
		...
		self.m_thumbnail = wx.StaticBitmap( self, wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.Size( 200,140 ), wx.BORDER_NONE )

		bSizer13.Add( self.m_thumbnail, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.EXPAND, 5 )

		self.m_title = wx.StaticText( self, wx.ID_ANY, u"Tiriel Supporting the Dying Myratana and Cursing His Sons", wx.DefaultPosition, wx.Size( -1,-1 ), 0 )
		self.m_title.Wrap( 160 )

		self.m_title.SetFont( wx.Font( 10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
		self.m_title.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_INFOBK ) )

		bSizer13.Add( self.m_title, 0, wx.ALIGN_LEFT|wx.ALL, 5 )

		self.m_artist = wx.StaticText( self, wx.ID_ANY, u"William Blake", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_artist.Wrap( 160 )

		self.m_artist.SetFont( wx.Font( wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
		self.m_artist.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_INFOBK ) )

		bSizer13.Add( self.m_artist, 0, wx.ALL, 5 )

		self.m_infodim = wx.StaticText( self, wx.ID_ANY, u"6600x4540px", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_infodim.Wrap( 160 )

		self.m_infodim.SetFont( wx.Font( 8, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
		self.m_infodim.SetForegroundColour( wx.Colour( 208, 208, 208 ) )

		bSizer13.Add( self.m_infodim, 0, wx.LEFT, 5 )

		self.m_infosize = wx.StaticText( self, wx.ID_ANY, u"Size: 3.45MB", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_infosize.Wrap( 160 )

		self.m_infosize.SetFont( wx.Font( 8, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
		self.m_infosize.SetForegroundColour( wx.Colour( 208, 208, 208 ) )

		bSizer13.Add( self.m_infosize, 0, wx.LEFT, 5 )

		self.m_infotype = wx.StaticText( self, wx.ID_ANY, u"Type: JPG", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_infotype.Wrap( 160 )

		self.m_infotype.SetFont( wx.Font( 8, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
		...
		self.m_pb1 = wx.Button( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.BORDER_NONE|wx.BORDER_NONE )
		self.m_pb1.SetBackgroundColour(wx.Colour(45,56,72))
		self.m_pb1.SetMinSize( wx.Size( 40,20 ) )

		fgSizer91.Add( self.m_pb1, 0, 0, 5 )

		self.m_pb2 = wx.Button( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.BORDER_NONE|wx.BORDER_NONE )
		self.m_pb2.SetBackgroundColour(wx.Colour(45,56,72))
		self.m_pb2.SetMinSize( wx.Size( 40,20 ) )

		fgSizer91.Add( self.m_pb2, 0, 0, 5 )

		self.m_pb3 = wx.Button( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.BORDER_NONE|wx.BORDER_NONE )
		self.m_pb3.SetBackgroundColour(wx.Colour(45,56,72))
		self.m_pb3.SetMinSize( wx.Size( 40,20 ) )

		fgSizer91.Add( self.m_pb3, 0, 0, 5 )

		self.m_pb4 = wx.Button( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.BORDER_NONE|wx.BORDER_NONE )
		self.m_pb4.SetBackgroundColour(wx.Colour(45,56,72))
		self.m_pb4.SetMinSize( wx.Size( 40,20 ) )

		fgSizer91.Add( self.m_pb4, 0, 0, 5 )

		self.m_pb5 = wx.Button( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.BORDER_NONE|wx.BORDER_NONE )
		...
		self.m_listCtrl1 = wx.ListCtrl( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.LC_REPORT|wx.LC_SINGLE_SEL|wx.BORDER_NONE )
		self.m_listCtrl1.SetFont( wx.Font( 10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
		...
		self.m_buttonRef = wx.Button( self, wx.ID_ANY, u"Refresh", wx.DefaultPosition, wx.Size( -1,32 ), wx.BORDER_NONE )
		self.m_buttonRef.SetFont( wx.Font( 10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
		self.m_buttonRef.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_INFOBK ) )
		...
		self.m_buttonOpen = wx.Button( self, wx.ID_ANY, u"Open Image", wx.DefaultPosition, wx.Size( -1,32 ), wx.BORDER_NONE )
		self.m_buttonOpen.SetFont( wx.Font( 10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
		self.m_buttonOpen.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_INFOBK ) )
		self.m_buttonOpen.SetBackgroundColour( wx.Colour( 70, 67, 97 ) )

		fgSizer10.Add( self.m_buttonOpen, 0, wx.LEFT, 1 )

		self.m_buttonEdit = wx.Button( self, wx.ID_ANY, u"Edit Filename", wx.DefaultPosition, wx.Size( -1,32 ), wx.BORDER_NONE )
		self.m_buttonEdit.SetFont( wx.Font( 10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
		self.m_buttonEdit.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_INFOBK ) )
		...
		"""self.m_search = wx.TextCtrl( self, wx.ID_ANY, u"Search...", wx.DefaultPosition, wx.Size( 200,32 ), 0|wx.BORDER_SIMPLE )
		self.m_search.SetFont( wx.Font( 10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Segoe UI Semibold" ) )
		...
		self.m_listCtrl1.Bind( wx.EVT_LIST_ITEM_FOCUSED, self.m_listCtrl1OnListItemFocused )
	...
	def m_pbOnButtonClick( self, event ):
		pyperclip.copy('%02x%02x%02x' % event.GetEventObject().GetBackgroundColour()[:-1]) #convert rgb to hex
	...
	def m_listCtrl1OnListItemFocused( self, event ):
		...
		self.m_title.SetLabel(self.m_listCtrl1.GetItemText(self.m_listCtrl1.GetFirstSelected(),0))
		self.m_title.Wrap(160)
		self.m_title.Refresh()
		self.m_artist.SetLabel(self.m_listCtrl1.GetItemText(self.m_listCtrl1.GetFirstSelected(),1))
		self.m_artist.Wrap(160)
		...
		try:
			...
			self.m_infodim.SetLabel(str(image.size[0])+"x"+str(image.size[1])) #dimensions
			self.m_infosize.SetLabel("Size: "+str(round(os.path.getsize(path)/(1024*1024),2))+"MB") #file size
			MAX_SIZE = (200, 140)
